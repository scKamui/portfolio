...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        {images.map((img, index) => (
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: currentImage === index ? 0.9 : 0 }}
      ...
      {/* === Main Section === */}
      <main className="relative z-20 flex flex-col items-center text-center px-4 sm:px-6 md:px-10 pt-24 pb-32 flex-grow">
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-12 bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 bg-clip-text text-transparent drop-shadow-[0_0_20px_#e60000a0]"
        ...
        <motion.div
          className="bg-black/60 backdrop-blur-md border-2 border-pink-500/40 rounded-2xl 
                     ...
                     text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-16"
        ...
        <motion.a
          ...
          className="bg-gradient-to-r from-red-500 to-pink-600 px-8 sm:px-10 py-4 sm:py-5 rounded-full text-lg sm:text-xl font-semibold text-white hover:scale-110 hover:shadow-[0_0_30px_#e60000a0] transition duration-300"
